...
export default function MovieCard({ movie_thumbnail, movie_title, source, setLoadedImagesCount, fetchUrl }: 
    {
        ...
        <Link href={`${fetchUrl}/video_file/${movie_title}.mp4`} className="pb-3">
            <Card className="py-1 px-3 shadow rounded-xl border border-gray-200 flex flex-col bg-gray-100">
                ...
                <CardBody className="py-2 overflow-visible">
                    ...
                    onLoad={() => setLoadedImagesCount((prevCount: number) => prevCount + 1)}
                    />
                </CardBody>
            </Card>
        </Link>
